...
// Controller with MailService dependency
...
//       const employee = this.employeeService.createEmployee(dto);
  
//       // Trigger email in the queue
//       await this.mailService.sendWelcomeEmail(employee);
...
//     updateEmployee(
//       @Param('id') id: string,
//       @Body() body: Partial<Pick<Employee, 'jobTitle' | 'department'>>,
//     ): Employee {
//       return this.employeeService.updateEmployee(id, body);
//     }
